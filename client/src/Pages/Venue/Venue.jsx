    ...
    >
      ...
      <div className="page-info">
        ...
        >
          ...
          <h2 className="info-title">Edificio Polifuncional &ldquo;José Luis Massera&rdquo;</h2>
          <div className="info-text">
            <p><MapPin size={14} style={{ marginRight: '4px', verticalAlign: 'middle' }} /> Senda Nelson Landoni 631, 11200 Montevideo</p>
          ...
          <div className="venue-highlights">
            ...
            <div className="venue-highlight">
              <Navigation size={16} />
              <span>Near Rio de la Plata</span>
            </div>
          </div>
        </motion.div>

        <motion.div 
          className="info-box map-box"
          variants={variants}
          initial="hidden"
          whileInView="visible"
          viewport={{ once: true, margin: "-100px" }}
        >
          <h2 className="info-title">Conference Venue on Map</h2>
        ...
        >
          ...
          <h3 className="hotel-name">Ibis Styles Montevideo</h3>
          ...
          <div className="rate-note">
            <Coffee size={16} />
            <span>Fees include breakfast</span>
          </div>

          <div className="info-text" style={{ marginTop: '1rem', textAlign: 'left' }}>
            <p>
              We suggest the <a href="https://all.accor.com/hotel/9712/index.es.shtml" target="_blank" rel="noreferrer">Hotel Ibis Styles Montevideo <ExternalLink size={12} /></a> for attending the conference.
            </p>
            <br />
            <p>
              Make your reservation by contacting manager Marcelo Fernández at <a href="mailto:marcelo.fernandez@accor.com">marcelo.fernandez@accor.com</a> and mention you are a QUITEL attendee.
            </p>
          </div>
        </motion.div>
